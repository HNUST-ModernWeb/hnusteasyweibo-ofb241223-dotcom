...
INSERT INTO posts (id, author_id, content, status, likes_count, reposts_count, comments_count, views_count, created_at) VALUES
  (1, 1, 'Welcome to HNUST Easy WeiBo! Share your thoughts and connect with others. #HNUST #Welcome', 'ACTIVE', 45, 0, 1, 23011, DATE_SUB(NOW(), INTERVAL 2 HOUR)),
  (2, 2, 'The library is so crowded today! Does anyone know a quiet place to study? 📚', 'ACTIVE', 10, 0, 0, 1542, DATE_SUB(NOW(), INTERVAL 5 HOUR)),
  (3, 3, 'Just finished my first React project! It was challenging but fun. 💻✨ #Coding #React', 'ACTIVE', 88, 0, 0, 9876, DATE_SUB(NOW(), INTERVAL 1 DAY));
